...
class TextStyleTransfer:
    ...
    def text_trans(self,opt):
        ...
        text_input = custom_text(style).cuda()
        ...
        # save_path = 'output/' + pathlib.Path(content).stem + '_' + pathlib.Path(style).stem + '.jpg'
        save_dir = 'input/output/'
